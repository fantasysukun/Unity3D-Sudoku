...
public class ConditionCheching1 : MonoBehaviour
{
    ...
    public static bool AllRowFilled;
    public static bool AllColumnFilled;
    public static bool AllGridFilled;
    public static bool AllFilled;
    public static int AllRowFilledCounter;
    public static int AllColumnFilledCounter;
    public static int AllGridFilledCounter;
    public static string result;

    public static int[,] BigMoveChecking;
    ...
    public void Start()
    {
        ...
        */
        ...
        //Initize BigMoveChecking1 & 2
        int[,] InitizeMap = map.easy;
        for (int RowT = 0; RowT < InitizeMap.GetLength(0); RowT++)
        {
            for (int ColT = 0; ColT < InitizeMap.GetLength(1); ColT++)
            {
                Specialchecking(BigMoveChecking, RowT, ColT, InitizeMap[RowT, ColT]);
            }
        }
    ...
    public static int Specialchecking(int[,] board, int row, int col, int c)
    {
        int BigMove = 0;
